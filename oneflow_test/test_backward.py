...
from flowvision.models.inception import inception_v3
from flowvision.models.mnasnet import mnasnet0_5, mnasnet0_75, mnasnet1_0, mnasnet1_3
from flowvision.models.mobilenetv2 import mobilenet_v2
from flowvision.models.mobilenetv3 import mobilenet_v3_large, mobilenet_v3_small
...
if __name__ == "__main__":
    ...
    def my_prune(model, example_inputs, output_transform, model_name):
        ...
        round_to = None
        try:
            if isinstance( model, flowvision.models.vision_transformer.VisionTransformer): round_to = model.encoder.layers[0].num_heads
        except:
            pass
        #########################################
        ...
        try:
            if isinstance(
                model, flowvision.models.vision_transformer.VisionTransformer
